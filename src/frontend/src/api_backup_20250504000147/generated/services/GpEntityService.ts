...
export class GpEntityService {
    ...
    public static getGpEntityCashflowsGpEntitySimulationIdCashflowsGet({
        ...
        simulationId: string,
        /**
         * Frequency of cashflows (yearly or monthly)
         */
        frequency?: string,
    ...
    public static getGpEntityVisualizationDataGpEntitySimulationIdVisualizationGet({
        ...
        simulationId: string,
        /**
         * Type of chart to retrieve (cashflows, revenue_sources, yearly_revenue, expense_breakdown, cashflow_over_time, dividend_over_time, team_allocation, portfolio_evolution, all)
         */
        chartType?: string,
        /**
         * Time granularity for time-series data (monthly, quarterly, yearly)
         */
        timeGranularity?: string,
        /**
         * Whether to return cumulative data for time-series charts
         */
        cumulative?: boolean,
        /**
