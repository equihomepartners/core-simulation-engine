...
/* tslint:disable */
/* eslint-disable */
import type { LeverageMetrics } from '../models/LeverageMetrics';
import type { LeveragePreviewRequest } from '../models/LeveragePreviewRequest';
import type { LeveragePreviewResponse } from '../models/LeveragePreviewResponse';
...
export class DefaultService {
    ...
    /**
     * List Zones
     * Return the complete Traffic-Light dataset (all suburb zone metrics).
     * @returns ZoneMetrics Successful Response
     * @throws ApiError
     */
    public getApiTrafficLightZones(): CancelablePromise<Array<ZoneMetrics>> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/api/traffic-light/zones',
        });
    }
    /**
     * Get Zone
     * Return a single zone record by its suburb id.
     * @param zoneId
     * @returns ZoneMetrics Successful Response
     * @throws ApiError
     */
    public getApiTrafficLightZones1(
        zoneId: string,
    ): CancelablePromise<ZoneMetrics> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/api/traffic-light/zones/{zone_id}',
            path: {
                'zone_id': zoneId,
            },
            errors: {
     ...
     *
     * @param requestBody
     * @returns LeveragePreviewResponse Successful Response
     * @throws ApiError
     */
    public postApiLeveragePreview(
        requestBody: LeveragePreviewRequest,
    ): CancelablePromise<LeveragePreviewResponse> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/api/leverage/preview',
            body: requestBody,
            mediaType: 'application/json',
        });
    }
    /**
     * Leverage Metrics
     * Return leverage metrics for a completed simulation run.
     * @param simulationId
     * @returns LeverageMetrics Successful Response
     * @throws ApiError
     */
    public getApiLeverageMetrics(
        simulationId: string,
    ): CancelablePromise<LeverageMetrics> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/api/leverage/metrics/{simulation_id}',
            path: {
                'simulation_id': simulationId,
            },
            errors: {
