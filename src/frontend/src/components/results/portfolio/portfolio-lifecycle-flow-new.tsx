...
interface PortfolioLifecycleFlowProps {
  results: any;
  isLoading: boolean;
}

export function PortfolioLifecycleFlow({
  results,
  isLoading
}: PortfolioLifecycleFlowProps) {
